...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(122438974756616329)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(122439190361625739)
,p_plugin_id=>wwv_flow_api.id(122438974756616329)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(122439443498630449)
,p_plugin_id=>wwv_flow_api.id(122438974756616329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(122439729536634078)
,p_plugin_id=>wwv_flow_api.id(122438974756616329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(122440024934642786)
,p_plugin_id=>wwv_flow_api.id(122438974756616329)
,p_attribute_scope=>'COMPONENT'
